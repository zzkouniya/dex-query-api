...
export default class OrdersHistoryCalculate {
  private readonly orderLock: Script
  private readonly sudtType: Script
  private readonly indexer: IndexerService

  private readonly txsByInputOutPoint: Map<string, Transaction>
  ...
  async calculateOrdersHistory (): Promise<OrderHistoryCalculateData[]> {
...
export interface OrderHistoryCalculateData {
  ...
  order_cells: OrderHistoryCalculateOutputs[]
}
