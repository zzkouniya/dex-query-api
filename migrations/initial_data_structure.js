...
exports.up = function (knex) {
  return knex.schema
    ...
    .createTableIfNotExists("transaction_inputs", function (table) {
      table.increments("id");
    ...
    .createTableIfNotExists("scripts", function (table) {
      table.increments("id");
    ...
    .createTableIfNotExists("transactions_scripts", function (table) {
      table.increments("id");
    ...
    .createTableIfNotExists("cells", function (table) {
      table.increments("id");
